...
#'
#' Każdy wiersz reprezentuje jeden typ ataku (alternatywę decyzyjną),
#' a kolumny opisują średnie wartości kryteriów obliczone na podstawie
#' co najmniej 20 zarejestrowanych incydentów.
#'
#' @format Ramka danych (data frame) z następującymi zmiennymi:
#' \describe{
#'   \item{Attack Type}{Typ ataku cybernetycznego (alternatywa MCDA)}
